...
import 'package:goals/goals/GoalDetails.dart';
                        ...
                        child: Column(
                          children : <Widget>[
                            Padding(
                              ...
                              child: Text(goals[index].goalName, style : TextStyle(fontSize : 24.0,color : Colors.white),),
                            ),
                            Padding(
                              padding: EdgeInsets.fromLTRB(8.0,0.0,8.0,8.0),
                              child: Text('${goals[index].getPercentageComplete().toStringAsFixed(2)}' + '% ',  style : TextStyle(fontSize : 18.0,color : Colors.white),),
                            ),
